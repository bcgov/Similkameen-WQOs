...
plotdata <- read_csv("data/report/NPMC_plots/tables/NP_sites2.csv")
...
plotdata$EMS_ID <- factor(plotdata$EMS_ID, levels=c( "E217193", "E206633"))

#units <- distinct(plotdata, Units)

# set working drive for plots
setwd('C:/R Projects/Similkameen-WQOs/data/report/NPMC_Plots/WQOs')
...
# Total Phosphorus Facet
site_P <- filter(plotdata, Variable %in% "phosphorus total")
Pplot <- ggplot(site_P, aes(x = DateTime, y = Value, shape=CENSOR)) +
  geom_point(size=0.75) + 
  theme_bw() +
  xlab("Date") +
  ylab("Total  (mg/L)") + coord_cartesian(ylim=c(0,0.35)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
...
Pplot <- ggplot(site_P, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  xlab("Date") +
  ylab("Total Dissolved Phosphorus (mg/L)") + coord_cartesian(ylim=c(0,0.3)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")
plot(Pplot)
...
Pplot <- ggplot(site_P, aes(x = DateTime, y = Value, shape=CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Dissolved Phosphorus (mg/L)") + coord_cartesian(ylim=c(0,0.35)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(face="bold", size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
crplot <- ggplot(site_cr, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 4.9,linetype = "WWQG Cr(III) IR"), color = "blue") +
...
Crplot <- ggplot(site_Cr, aes(x = DateTime, y = Value, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 1,linetype = "Cr(VI) AL"), color = "red") +
...
Crplot <- ggplot(site_Cr, aes(x = DateTime, y = Value, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 1,linetype = "WWQG Cr(VI) AL"), color = "red") +
  scale_linetype_manual(name = "T Cr", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  xlab("Date") +
...
site_wad <- filter(plotdata, Variable %in% c("cyanide s.a.d." ))
wadplot <- ggplot(site_wad, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  labs(color="Station", shape="<MDL")
plot(wadplot)
ggsave(filename = "CnSAD.png", plot = wadplot, h=4, w=6, units="in", dpi=300)
...
wadplot <- ggplot(site_wad, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 10,linetype = "AL-Acute"), color = "blue") +
  geom_hline(aes(yintercept = 5,linetype = "AL-Chronic"), color = "red") +
  scale_linetype_manual(name = "WQG", values = c(2, 2),  
...
feplot <- ggplot(site_fe, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  geom_hline(aes(yintercept = 0.3,linetype = "WQO Acute"), color = "red") +
...
moplot <- ggplot(site_mo, aes(x = DateTime, y = Value, color = EMS_ID)) +
  ...
  geom_hline(aes(yintercept = 0.05,linetype = "WQO Acute"), color = "blue") +
  scale_linetype_manual(name = "T Mo", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
seplot <- ggplot(site_se, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = "WQO Acute"), color = "blue") +
  geom_hline(aes(yintercept = 2,linetype = "WQG Chronic AL"), color = "red") +
  scale_linetype_manual(name = "T Se", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
phplot <- ggplot(site_ph, aes(x = DateTime, y = Value, color = EMS_ID)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 9,linetype = "Max"), color = "red") +
...
Coplot <- ggplot(site_co, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 4,linetype = "Chronic AL"), color = "red") +
  scale_linetype_manual(name = "T Co WQG", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
...
agplot <- ggplot(site_ag, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = "WQO Acute"), color = "blue") +
  geom_hline(aes(yintercept = 0.1,linetype = "WQG Acute AL"), color = "red") +
  scale_linetype_manual(name = "T-Ag", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
mnplot2 <- ggplot(site_mn3, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E217193")
plot(mnplot2)
ggsave(filename = "T+D E217193.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)

#T&D Mn E206633 w/WQGs
site_mn4 <- filter(site_mn2, Variable %in% c("manganese total", 
                                            "manganese dissolved",
                                            "AcuteAL", "ChronicAL") 
                   & EMS_ID == "E206633")
mnplot3 <- ggplot(site_mn4, aes(x = DateTime, y = Value, col = Variable)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E206633")
plot(mnplot3)
ggsave(filename = "T+D MnE206633.png", plot = mnplot3, h=4, w=6, units="in", dpi=300)
...
pbplot2 <- ggplot(site_pb3, aes(x = DateTime, y = Value, col = Variable, shape=CENSOR)) +
  ...
  labs(col = "E217193", shape= "<MDL")
plot(pbplot2)
ggsave(filename = "T+D pbE217193.png", plot = pbplot2, h=4, w=6, units="in", dpi=300)

#T&D Pb E206633 w/WQGs
...
pbplot2 <- ggplot(site_pb4, aes(x = DateTime, y = Value, col = Variable, shape=CENSOR)) +
  ...
  xlab("Date") +
  ylab("Concentration"~~(mu*g/L)) + 
  labs(col = "E206633", shape="<MDL)")
plot(pbplot2)
ggsave(filename = "T+D PbE206633.png", plot = pbplot2, h=4, w=6, units="in", dpi=300)
...
cdplot <- ggplot(site_cd, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 20,linetype = "Acute"), color = "red") +
  scale_linetype_manual(name = "WQ0", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
...
cdplot <- ggplot(site_cd, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(cdplot)
ggsave(filename = "T+D Cd2.png", plot = cdplot, h=4, w=6, units="in", dpi=300)

# Total Cd facet

site_cd <- filter(plotdata, Variable %in% "cadmium total")
cdplot <- ggplot(site_cd, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  theme_bw() +
  xlab("Date") +
...
cdplot2 <- ggplot(site_cd3, aes(x = DateTime, y = Value, col = Variable)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E217193")
plot(cdplot2)
ggsave(filename = "T+D cdE217193.png", plot = cdplot2, h=4, w=6, units="in", dpi=300)

#T&D Cd E206633 w/WQGs
...
site_cd4$Variable <- factor(site_cd4$Variable, 
                            levels=c("AcuteAL", "ChronicAL", "cadmium total", 
                                     "cadmium dissolved"))
cdplot3 <- ggplot(site_cd4, aes(x = DateTime, y = Value, col = Variable, shape=CENSOR)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E206633", shape="<MDL")
plot(cdplot3)
ggsave(filename = "T+D CdE206633.png", plot = cdplot3, h=4, w=6, units="in", dpi=300)
...
niplot <- ggplot(site_ni, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Nickel"~~(mu*g/L)) + coord_cartesian(ylim=c(0,0.75)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Zinc"~~(mu*g/L)) + coord_cartesian(ylim=c(0,55)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(znplot)
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Zinc"~~(mu*g/L)) + coord_cartesian(ylim=c(0,55)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
so4plot <- ggplot(site_so4, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  facet_wrap(~EMS_ID, ncol=2, drop=FALSE)
plot(so4plot)
ggsave(filename = "DSO4WQO_facet.png", plot = so4plot, h=4, w=6, units="in", dpi=300)
...
noplot <- ggplot(site_no, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  scale_linetype_manual(name = "T-NO2-", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
noplot <- ggplot(site_no, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Nitrite (mg/L)") + coord_cartesian(ylim=c(0,0.06)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
# load Turbidity function that is based on 2 conditions and then run 

(ntu_WQO<-turbidity2_WQO(plotdata, "E217193", 10, 20, 50))

#write csv of Turbidity threshold 
write.csv(ntulimits,'C:/R Projects/Similkameen-WQOs/data/report/NPMC_Plots/tables/NP_turbidity.csv', row.names = FALSE)
...
tubidity_WQO <- subset(ntulimits, select = -c(Code, ResultLetter, Station, CENSOR))
...
## plot turbidity against threshold for E217193
...
ntuplot2 <- ggplot(ntu_WQO, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E217193", shape="<MDL")
plot(ntuplot2)
ggsave(filename = "Turbidity_WQO E217193.png", plot = ntuplot2, h=4, w=6, units="in", dpi=300)
...
NH4plot <- ggplot(site_NH4, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Ammonia (mg/L)") + coord_cartesian(ylim=c(0,0.2)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(NH4plot)
...
NH4plot <- ggplot(site_NH4, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Ammonia (mg/L)") + coord_cartesian(ylim=c(0,0.2)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
#make dataframe of NPMC sites
NH4_NP <- filter(NH4WQGs, EMS_ID == "E217193" | EMS_ID == "E206633")
#plot data in specific order
NH4WQGs$EMS_ID <- factor(NH4WQGs$EMS_ID, 
                        levels=c("E217193", "E206633")) 


NH4plot2 <- ggplot(NH4_NP, aes(x = DateTime, y = Value, color = Variable, shape = CENSOR)) +
  geom_point(size=0.75) + 
  theme_bw() +
  xlab("Date") + 
...
Cuplot <- ggplot(site_Cu, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) +
  geom_hline(aes(yintercept = 300,linetype = "WQO Acute"), color = "red") +
  scale_linetype_manual(name = "T Cu", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
