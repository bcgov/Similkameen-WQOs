...
WC_sites <- filter(sim_data, EMS_ID == "0500083" | EMS_ID == "E318572" | EMS_ID == "E206637" |
                     EMS_ID == "E318571")
...
write.csv(WC_sites,'C:/R Projects/Similkameen-WQOs/data/report/Tribs/tables/tribs.csv', row.names = FALSE)
...
setwd('C:/R Projects/Similkameen-WQOs/data/report/Tribs/High_NDs')
...
WC_sites %<>% filter(!(Variable == "aluminum dissolved" & CENSOR == TRUE & Value >= 0.2|
                         Variable == "cadmium dissolved" & CENSOR == TRUE & Value >= 10|
                         Variable == "cadmium total" & CENSOR == TRUE & Value >= 6.0|
                         Variable == "chromium dissolved" & CENSOR == TRUE & Value >= 5.0|
                         Variable == "cyanide wad" & CENSOR == TRUE & Value >= 30|
                         Variable == "cyanide s.a.d." & CENSOR == TRUE & Value >= 30|
                         Variable == "lead dissolved" & CENSOR == TRUE & Value >= 5|
                         ...
                         Variable == "nitrite total" & CENSOR == TRUE & Value >= 0.03|
                         Variable == "ammonia dissolved" & CENSOR == TRUE & Value >= 0.1|
...
write.csv(WC_sites,'C:/R Projects/Similkameen-WQOs/data/report/Tribs/tables/tribs2.csv', row.names = FALSE)
