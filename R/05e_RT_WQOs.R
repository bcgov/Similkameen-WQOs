...
plotdata <- read_csv("data/report/RT_plots/tables/RT_sites2.csv")
...
# no Cu BLM results for RT sites
...
tdsplot <- ggplot(site_tds, aes(x = DateTime, y = Value, color = EMS_ID)) +
  geom_point() + 
  geom_hline(aes(yintercept = 500,linetype = "Acute"), color = "red") +
...
tssplot <- ggplot(site_tss, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) +
  xlab("Date") +
  ylab("TSS (mg/L)") + coord_cartesian(ylim=c(0,250)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")
plot(tssplot)
...
#facet for TSS
site_tss <- filter(plotdata, Variable %in% "tss")
tssplot <- ggplot(site_tss, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  theme_bw() +
  xlab("Date") +
  ylab("TSS (mg/L)") + coord_cartesian(ylim=c(0,250)) +
...
(tsslimits<-TSS_WQO(plotdata, "E215956", 20, 20, 100))

#write csv of TSS threshold, data shows clear flows for threshold is 10 mg/L 
write.csv(tsslimits,'C:/R Projects/Similkameen-WQOs/data/report/RT_Plots/tables/RT_tss_E215956.csv', row.names = FALSE)
...
tssplot <- ggplot(site_tss, aes(x = DateTime, y = Value, shape=CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("TSS (mg/L)") + coord_cartesian(ylim = c(0, 225)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(strip.text = element_text(face="bold", size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
  theme(text=element_text(size=8)) +
...
#filter out downstream site to compare to WQO
site_tss2 <- dplyr::filter(site_tss, EMS_ID == "E206638")
#combine WQO with ds station
site_tss3 <- bind_rows(site_tss2, tsslimits2, id=NULL)
#filter our WQO and d/s station
site_tss3 <- filter(site_tss3, EMS_ID == "E206638" | 
                      EMS_ID == "E215956" & Variable == "WQO")

#Plot E206638 against WQO for u/s E215956

tssplot <- ggplot(site_tss3, aes(x = DateTime, y = Value, color = Variable, shape=CENSOR)) +
  geom_point() + 
  theme_classic() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key = element_blank()) +
  theme(legend.key.size = unit(0.2, "cm")) +
  xlab("Date") +
  ylab("E206638 TSS (mg/L)") + coord_cartesian(ylim=c(0,250)) +
  theme(text=element_text(size=8)) +
  labs(color="Variable", shape="<MDL")
plot(tssplot) 
ggsave(filename = "tssWQO_E215956.png", plot = tssplot, h=4, w=6, units="in", dpi=300)

# WQO for E215957
(tsslimits<-TSS_WQO(plotdata, "E215957", 20, 20, 100))

#write csv of TSS threshold, data shows clear flows for threshold is 10 mg/L 
write.csv(tsslimits,'C:/R Projects/Similkameen-WQOs/data/report/RT_Plots/tables/RT_tss_E215957.csv', row.names = FALSE)

#not plotting as there are only 2 tss data points for E215957
...
crplot <- ggplot(site_cr, aes(x = DateTime, y = Value, color = EMS_ID)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 8.9,linetype = "AL Chronic Cr(III)"), color = "blue") +
  geom_hline(aes(yintercept = 2,linetype = "AL Chronic Cr(VI)"), color = "red") +
  scale_linetype_manual(name = "T Cr WWQG", values = c(2, 2),  
...
crplot <- ggplot(site_cr, aes(x = DateTime, y = Value, color = EMS_ID)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Chromium"~~(mu*g/L)) + coord_cartesian(ylim=c(0,2.0)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(crplot)
ggsave(filename = "T+D Cr2.png", plot = crplot, h=4, w=6, units="in", dpi=300)

# total Cr facet

site_Cr <- filter(plotdata, Variable %in% "chromium total")
Crplot <- ggplot(site_Cr, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 2,linetype = "AL Chronic Cr(VI)"), color = "red") +
...
wadplot <- ggplot(site_wad, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 100,linetype = "Acute"), color = "blue") +
  geom_hline(aes(yintercept = 5,linetype = "WQG Chronic AL"), color = "red") +
...
wadplot <- ggplot(site_wad, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  xlab("Date") +
  ylab("Cyanide W.A.D."~~(mu*g/L)) + coord_cartesian(ylim = c(0,900)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL") + 
  ggtitle("WQO Below HWY")
plot(wadplot)
ggsave(filename = "CnWAD2.png", plot = wadplot, h=4, w=6, units="in", dpi=300)
...
sadplot <- ggplot(site_sad, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 200,linetype = "Acute"), color = "red") +
  scale_linetype_manual(name = "WQO", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_classic() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
...
sadplot <- ggplot(site_sad, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  xlab("Date") +
  ylab("Cyanide S.A.D."~~(mu*g/L)) + coord_cartesian(ylim = c(0,900))+
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  ggtitle("WQO Above HWY")
plot(sadplot)
ggsave(filename = "CnSAD2.png", plot = sadplot, h=4, w=6, units="in", dpi=300)
...
asplot <- ggplot(site_as, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = "WQO Acute"), color = "blue") +
...
asplot <- ggplot(site_as, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = "WQO Acute"), color = "red") +
  scale_linetype_manual(name = "T As", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Arsenic"~~(mu*g/L)) + coord_cartesian(ylim=c(0,325))+
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(asplot)
...
asplot <- ggplot(site_as, aes(x = DateTime, y = Value, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = "Acute"), color = "red") +
  scale_linetype_manual(name = "WQO", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  xlab("Date") +
...
asplot <- ggplot(site_as, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Arsenic"~~(mu*g/L)) + coord_cartesian(ylim = c(0,350)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  labs(shape="<MDL")+
  theme(strip.text = element_text(face="bold", size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
  ...
  facet_wrap(~EMS_ID, ncol=2, drop=FALSE)
plot(asplot)
ggsave(filename = "TAs_facet2.png", plot = asplot, h=4, w=6, units="in", dpi=300)
...
feplot <- ggplot(site_fe, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 0.35,linetype = "WQG Acute AL"), color = "blue") +
  geom_hline(aes(yintercept = 0.3,linetype = "WQO=WQG DW"), color = "red") +
  scale_linetype_manual(name = "D Fe", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
feplot <- ggplot(site_fe, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Iron (mg/L)") + coord_cartesian(ylim=c(0,11)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(feplot)
ggsave(filename = "T+D Fe2.png", plot = feplot, h=4, w=6, units="in", dpi=300)
#ggplotly(feplot)
...
feplot <- ggplot(site_fe, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  geom_hline(aes(yintercept = 0.35,linetype = "WQG Acute AL"), color = "blue") +
  geom_hline(aes(yintercept = 0.3,linetype = "WQO=WQG DW"), color = "red") +
  scale_linetype_manual(name = "Benchmark", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  xlab("Date") +
...
hgplot <- ggplot(site_hg, aes(x = DateTime, y = Value, shape=CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 1,linetype = "Above HWY (WQG AL)"), color = "blue") +
  geom_hline(aes(yintercept = 0.1,linetype = "Below HWY"), color = "red") +
  scale_linetype_manual(name = "WQO", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  xlab("Date") +
...
## the wqo if for data between May-Sept, look at graphs to see if those months need to be 
# pulled out - No, no issue with Mo
...
moplot <- ggplot(site_mo, aes(x = DateTime, y = Value, color = EMS_ID)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 0.05,linetype = "WQG Acute LS"), color = "blue") +
  geom_hline(aes(yintercept = 0.01,linetype = "WQG Chronic IR"), color = "red") +
  scale_linetype_manual(name = "WQO", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
...
moplot <- ggplot(site_mo, aes(x = DateTime, y = Value)) +
  ...
  scale_linetype_manual(name = "WQO/WQG", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  xlab("Date") +
  ylab("Total Molybdenum (mg/L)") +
...
# filter out data to compare to WQO, May to Sept
site_mo<- filter(plotdata, Variable %in% "molybdenum total")

MaySep <- site_mo[month(site_mo$DateTime) >= 5 & month(site_mo$DateTime) <= 9,]

moplot <- ggplot(MaySep, aes(x = DateTime, y = Value, color = EMS_ID)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 0.01,linetype = "Chronic IR"), color = "red") +
  scale_linetype_manual(name = "WQO/WQG", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  ...
  labs(color="Station")
plot(moplot)
ggsave(filename = "Mo_MaySept.png", plot = moplot, h=4, w=6, units="in", dpi=300)
...
urplot <- ggplot(site_ur, aes(x = DateTime, y = Value, color = EMS_ID)) +
  geom_point(size=0.75) + 
...
seplot <- ggplot(site_se, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 10,linetype = "Above HWY"), color = "blue") +
  geom_hline(aes(yintercept = 1,linetype = "Below HWY"), color = "red") +
  scale_linetype_manual(name = "WQO T-Se", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(seplot)
ggsave(filename = "T+D Se2.png", plot = seplot, h=4, w=6, units="in", dpi=300)
...
seplot <- ggplot(site_se, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Selenium"~~(mu*g/L)) + coord_cartesian(ylim = c(0,7.5)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  labs(shape="<MDL")+
...
alplot <- ggplot(site_al, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 0.05,linetype = "WQG Chronic D Al"), color = "red") +
  geom_hline(aes(yintercept = 0.3,linetype = "WQO Acute T Al"), color = "blue") +
  scale_linetype_manual(name = "Benchmark", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
...
alplot <- ggplot(site_al, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 0.3,linetype = "Acute"), color = "red") +
  scale_linetype_manual(name = "WQO", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  xlab("Date") +
...
coplot <- ggplot(site_co, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 110,linetype = "Acute AL"), color = "blue") +
...
agplot <- ggplot(site_ag, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = "Above HWY"), color = "blue") +
  geom_hline(aes(yintercept = 0.1,linetype = "Below HWY"), color = "red") +
  scale_linetype_manual(name = "WQO T-Ag", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
agplot <- ggplot(site_ag, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 0.1,linetype = " WQO/WQG Acute AL"), color = "blue") +
  geom_hline(aes(yintercept = 0.05,linetype = "Chronic AL"), color = "red") +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Silver"~~(mu*g/L)) + coord_cartesian(ylim = c(0,0.1)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape = "<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(agplot)
ggsave(filename = "T+D Ag2.png", plot = agplot, h=4, w=6, units="in", dpi=300)
...
agplot <- ggplot(site_ag, aes(x = DateTime, y = Value, shape=CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Silver"~~(mu*g/L)) + ylim(0,0.1) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
mnplot2 <- ggplot(site_mn3, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E206638")
plot(mnplot2)
ggsave(filename = "T+D Mn_E206638.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)

#T&D Mn E215956 w/WQGs
site_mn4 <- filter(site_mn2, Variable %in% c("manganese total", 
                                             "manganese dissolved",
                                             "AcuteAL", "ChronicAL") 
                   & EMS_ID == "E215956")
mnplot2 <- ggplot(site_mn4, aes(x = DateTime, y = Value, col = Variable)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E215956")
plot(mnplot2)
ggsave(filename = "T+D MnE215956.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)

#T&D Mn E215957 w/WQGs
site_mn5 <- filter(site_mn2, Variable %in% c("manganese total", 
                                             "manganese dissolved",
                                             "AcuteAL", "ChronicAL") 
                   & EMS_ID == "E215957")
mnplot2 <- ggplot(site_mn5, aes(x = DateTime, y = Value, col = Variable)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E215957")
plot(mnplot2)
ggsave(filename = "T+D MnE215957.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)
...
pbplot <- ggplot(site_pb, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) +
  geom_hline(aes(yintercept = 15,linetype = "Acute"), color = "blue") +
  geom_hline(aes(yintercept = 0.5,linetype = "Chronic"), color = "red") +
  scale_linetype_manual(name = "T-Pb", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
pbplot <- ggplot(site_pb, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) +
  geom_hline(aes(yintercept = 50,linetype = "Acute"), color = "red") +
  scale_linetype_manual(name = "T-Pb", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(pbplot)
ggsave(filename = "T+D Pb2.png", plot = pbplot, h=4, w=6, units="in", dpi=300)
# Total Pb facet
...
cdplot <- ggplot(site_cd, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 5,linetype = "Above HWY"), color = "blue") +
  geom_hline(aes(yintercept = 0.2,linetype = "Below HWY"), color = "red") +
  scale_linetype_manual(name = "WQO T Cd", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
cdplot <- ggplot(site_cd, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Cadmium"~~(mu*g/L)) + coord_cartesian(ylim = c(0,0.04)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
niplot <- ggplot(site_ni, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  scale_linetype_manual(name = "WQO/WWQG T-Ni", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 50,linetype = " WQO Acute"), color = "blue") +
  geom_hline(aes(yintercept = 7.5,linetype = " WQG Chronic AL"), color = "red") +
  scale_linetype_manual(name = "T-Zn", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(znplot)
ggsave(filename = "T+D Zn2.png", plot = znplot, h=4, w=6, units="in", dpi=300)
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Zinc"~~(mu*g/L)) + coord_cartesian(ylim = c(0,55))+
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
so4plot <- ggplot(site_so4, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 429,linetype = "AL (hardness 181-250)"), color = "red") +
...
so4plot <- ggplot(site_so4, aes(x = DateTime, y = Value)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 150,linetype = "Acute"), color = "blue") +
  geom_hline(aes(yintercept = 50,linetype = "Chronic"), color = "red") +
  scale_linetype_manual(name = "WQO", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  xlab("Date") +
...
#T&D nitrite
plotnames <- c('nitrite total' = "T-NO2-", 'nitrite dissolved' = "D-NO2-")

#remove TNo2 mdls
plotdata <- plotdata %>% 
  dplyr::filter(!(Variable == "nitrite total" & Value>=0.03 |
                    Variable == "nitrite dissolved" & Value>=0.03))

site_no <- filter(plotdata, Variable %in% c("nitrite total", "nitrite dissolved"))
noplot <- ggplot(site_no, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  scale_linetype_manual(name = "WQO/WQG T-NO2-", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(noplot)
ggsave(filename = "T+D NO2.png", plot = noplot, h=4, w=6, units="in", dpi=300)
...
spcplot <- ggplot(site_spc, aes(x = DateTime, y = Value)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Specific Conductance"~~(mu*s/cm)) + coord_cartesian(ylim = c(0,1000)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
ntuplot <- ggplot(site_ntu, aes(x = DateTime, y = Value, color = EMS_ID)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) +
  xlab("Date") +
  ylab("Turbidity (NTU)") + coord_cartesian(ylim=c(0,150)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")
plot(ntuplot)
ggsave(filename = "turbidity2.png", plot = ntuplot, h=4, w=6, units="in", dpi=300)
...
(ntu_WQO<-turbidity2_WQO(plotdata, "E215956", 5, 10, 50))

#write csv of turbidity threshold, data shows clear flows for threshold is 10 mg/L 
write.csv(tubidity_WQO,'C:/R Projects/Similkameen-WQOs/data/report/RT_Plots/tables/RT_turbidity.csv', row.names = FALSE)
...
ntuplot2 <- ggplot(site_ntu, aes(x = DateTime, y = Value, shape=CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Turbidity (NTU)") + coord_cartesian(ylim=c(0,600)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(strip.text = element_text(face="bold", size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
  theme(text=element_text(size=8)) +
...
#first remove columns
tubidity_WQO <- subset(tubidity_WQO, select = -c(Code, ResultLetter, Station, CENSOR))
#make dataframe of WQO
...
#combine turbidity_WQO and WQO2
ntu_WQO <- bind_rows(tubidity_WQO, WQO2, id=NULL)
#remove threshold column
ntu_WQO <- subset(ntu_WQO, select = -Threshold)

#filter out downstream site to compare to WQO
site_ntu2 <- dplyr::filter(site_ntu, EMS_ID == "E206638")
#combine WQO with ds station
site_ntu3 <- bind_rows(site_ntu2, ntu_WQO, id=NULL)
#filter our WQO and d/s station
site_ntu3 <- filter(site_ntu3, EMS_ID == "E206638" | 
                      EMS_ID == "E215956" & Variable == "WQO")


## plot turbidity against threshold for E206635

ntuplot2 <- ggplot(site_ntu3, aes(x = DateTime, y = Value, col = Variable)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E206638", shape="<MDL")
plot(ntuplot2)
ggsave(filename = "Turbidity_WQO E206638.png", plot = ntuplot2, h=4, w=6, units="in", dpi=300)
...
ntuplot2 <- ggplot(site_ntu3, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Concentration"~~(mu*g/L)) + coord_cartesian(ylim = c(0,150)) +
  labs(col = "E206638", shape="<MDL")
plot(ntuplot2)
ggsave(filename = "Turbidity_WQO2 E206638.png", plot = ntuplot2, h=4, w=6, units="in", dpi=300)
...
## make dataframe of RTGC Creek sites
NH4_RT <- filter(NH4WQGs, EMS_ID == "E215956" | EMS_ID == "E215957" |
                   EMS_ID == "E206638")


#plot data in specific order
NH4_RT$EMS_ID <- factor(NH4_RT$EMS_ID, 
                        levels=c( "E215956", "E215957", "E206638"))


NH4plot2 <- ggplot(NH4_RT, aes(x = DateTime, y = Value, color = Variable, shape = CENSOR)) +
  geom_point(size=0.75) + 
  theme_bw() +
  xlab("Date") + 
  ylab("Dissolved Ammonia (mg/L)") + 
