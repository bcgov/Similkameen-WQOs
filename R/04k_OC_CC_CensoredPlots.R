...
KR_sites <- filter(sim_data, EMS_ID == "E221526" | EMS_ID == "E221525")
...
write.csv(KR_sites,'C:/R Projects/Similkameen-WQOs/data/report/OC_CC_Plots/tables/OC_CC_sites.csv', row.names = FALSE)
...
setwd('C:/R Projects/Similkameen-WQOs/data/report/OC_CC_Plots/High_ND')
...
KR_sites %<>% filter(!(Variable == "cadmium total" & CENSOR == TRUE & Value >= 0.01))
...
write.csv(KR_sites,'C:/R Projects/Similkameen-WQOs/data/report/OC_CC_Plots/tables/OC_CC_sites2.csv', row.names = FALSE)
