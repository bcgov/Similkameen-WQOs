...
# Load WC data
WC_sites <- read.csv("data/report/WC_Plots/tables/WC_sites.csv", 
...
write.csv(table.1,'data/report/WC_Plots/tables/Table1_censored.csv', row.names = FALSE)
...
write.csv(method_summary,'data/report/WC_Plots/tables/MethodSummary.csv', row.names = FALSE)
...
write.csv(summary_stats,'data/report/WC_Plots/tables/SummaryStats.csv', row.names = FALSE)
...
sumstats <- read.csv("data/report/WC_plots/tables/SummaryStats.csv", 
                     stringsAsFactors = FALSE, header=TRUE)
...
for (i in 1:length(parameters)){
  ...
  ggsave(filename=paste0("C:/R Projects/Similkameen-WQOs/data/report/WC_Plots/",x,".tiff"), units="in", width=9, height=6, dpi=300, compression = 'lzw')
