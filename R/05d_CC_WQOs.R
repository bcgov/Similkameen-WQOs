...
# This script will graph the parameters for Cahill Creek, plot WQGs/WQOs
...
plotdata <- read_csv("data/report/CC_plots/tables/CC_sites2.csv")
...
tssplot <- ggplot(site_tss, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) +
  xlab("Date") +
  ylab("TSS (mg/L)") + coord_cartesian(ylim=c(0,75)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")
plot(tssplot)
...
(tsslimits<-TSS_WQO(plotdata, "E206635", 10, 10, 100))

#write csv of TSS threshold, data shows clear flows for threshold is 10 mg/L 
write.csv(tsslimits,'C:/R Projects/Similkameen-WQOs/data/report/CC_Plots/tables/CC_tss_belowHWY.csv', row.names = FALSE)
...
## plot tss against threshold for E206635
...
tssplot2 <- ggplot(tsslimits2, aes(x = DateTime, y = Value, col = Variable, shape=CENSOR)) +
  ...
  labs(col = "E206635", shape="<MDL") +
  ggtitle("WQO Below HWY")
plot(tssplot2)
ggsave(filename = "TSS_WQO_belowHWY_E206635.png", plot = tssplot2, h=4, w=6, units="in", dpi=300)

(tsslimits<-TSS_WQO(plotdata, "E206635", 20, 20, 100))

#write csv of TSS threshold, data shows clear flows for threshold is 10 mg/L 
write.csv(tsslimits,'C:/R Projects/Similkameen-WQOs/data/report/CC_Plots/tables/CC_tss_aboveHWY.csv', row.names = FALSE)
...
plot(tssplot2)
ggsave(filename = "TSS_WQO_aboveHWY_E206635.png", plot = tssplot2, h=4, w=6, units="in", dpi=300)
...
crplot <- ggplot(site_cr, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Chromium"~~(mu*g/L)) + coord_cartesian(ylim=c(0,10)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(crplot)
...
Crplot <- ggplot(site_Cr, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  geom_hline(aes(yintercept = 8.9,linetype = "AL Chronic Cr(III)"), color = "blue") +
  geom_hline(aes(yintercept = 2,linetype = "AL Chronic Cr(VI)"), color = "red") +
  scale_linetype_manual(name = "WWQG", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("blue", "red")))) +
  theme_bw() +
  xlab("Date") +
  ylab("Total Chromium"~~(mu*g/L)) + coord_cartesian(ylim=c(0,10)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  labs(shape="<MDL")+
...
wadplot <- ggplot(site_wad, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 5,linetype = "Chronic AL"), color = "red") +
...
asplot <- ggplot(site_as, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Arsenic"~~(mu*g/L)) + coord_cartesian(ylim=c(0,150))+
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(asplot)
...
asplot <- ggplot(site_as, aes(x = DateTime, y = Value)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Arsenic"~~(mu*g/L)) + coord_cartesian(ylim=c(0,60)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
feplot <- ggplot(site_fe, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Iron (mg/L)") + coord_cartesian(ylim=c(0,2.25)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(feplot)
...
feplot <- ggplot(site_fe, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  labs(shape="<MDL")+  coord_cartesian(ylim= c(0,2.0)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
  facet_wrap(~EMS_ID, ncol=2, drop=FALSE)
plot(feplot)
...
urplot <- ggplot(site_ur, aes(x = DateTime, y = Value, color = EMS_ID)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Uranium"~~(mu*g/L)) + coord_cartesian(ylim = c(0,2.25)) +
  theme(text=element_text(size=8)) +
  labs(color="Station")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(urplot)
ggsave(filename = "T+D Ur2.png", plot = urplot, h=4, w=6, units="in", dpi=300)
...
seplot <- ggplot(site_se, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Selenium"~~(mu*g/L)) + coord_cartesian(ylim = c(0,10)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape = "<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(seplot)
...
alplot <- ggplot(site_al, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Aluminum (mg/L)") + coord_cartesian(ylim=c(0,2.25)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape = "<MDL")+
  ggtitle("WQO below HWY") +
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
...
alplot <- ggplot(site_al, aes(x = DateTime, y = Value)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Aluminum (mg/L)") + coord_cartesian(ylim=c(0,2.5)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  labs(shape="<MDL")+
...
Coplot <- ggplot(site_co, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Cobalt"~~(mu*g/L)) + coord_cartesian(ylim = c(0,75)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  labs(shape="<MDL")+
  ...
  facet_wrap(~EMS_ID, ncol=2, drop=FALSE)
plot(Coplot)
ggsave(filename = "DCo_facet2.png", plot = Coplot, h=4, w=6, units="in", dpi=300)
...
agplot <- ggplot(site_ag, aes(x = DateTime, y = Value, color = EMS_ID, shape = CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Silver"~~(mu*g/L)) + coord_cartesian(ylim = c(0,0.35)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape = "<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(agplot)
...
agplot <- ggplot(site_ag, aes(x = DateTime, y = Value, shape=CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Silver"~~(mu*g/L)) + coord_cartesian(ylim = c(0,0.11))+
  labs("<MDL")+
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
...
mnplot2 <- ggplot(site_mn3, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E206635")
plot(mnplot2)
ggsave(filename = "T+D Mn_E206635.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)

#T&D Mn E206824 w/WQGs
...
mnplot2 <- ggplot(site_mn4, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E206824")
plot(mnplot2)
ggsave(filename = "T+D MnE206824.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)

#T&D Mn E206636 w/WQGs
...
mnplot2 <- ggplot(site_mn5, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E206636")
plot(mnplot2)
ggsave(filename = "T+D MnE206636.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)

#T&D Mn E206637 w/WQGs
site_mn6 <- filter(site_mn2, Variable %in% c("manganese total", 
                                             "manganese dissolved",
                                             "AcuteAL", "ChronicAL") 
                   & EMS_ID == "E206637")
mnplot2 <- ggplot(site_mn6, aes(x = DateTime, y = Value, col = Variable)) +
  geom_point(size=0.75) + 
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  ...
  labs(col = "E206637")
plot(mnplot2)
ggsave(filename = "T+D MnE206637.png", plot = mnplot2, h=4, w=6, units="in", dpi=300)
...
pbplot <- ggplot(site_pb, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  geom_hline(aes(yintercept = 5,linetype = "Chronic"), color = "red") +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Lead"~~(mu*g/L)) + coord_cartesian(ylim = c(0,15)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  ggtitle("WQO Below HWY") +
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
...
niplot <- ggplot(site_ni, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Total Nickel"~~(mu*g/L)) + coord_cartesian(ylim = c(0,10)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  ...
  theme(text=element_text(size=8)) +
  xlab("Date") +
  ylab("Zinc"~~(mu*g/L)) + coord_cartesian(ylim = c(0,50)) +
  theme(text=element_text(size=8)) +
  labs(color="Station", shape="<MDL")+
  facet_wrap(~Variable, ncol=2, labeller = as_labeller(plotnames))
plot(znplot)
...
znplot <- ggplot(site_zn, aes(x = DateTime, y = Value, shape = CENSOR)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Dissolved Zinc"~~(mu*g/L)) + coord_cartesian(ylim = c(0,50)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(text=element_text(size=8)) +
  theme(strip.text = element_text(size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
...
noplot <- ggplot(site_no, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 1,linetype = "Acute"), color = "red") +
  scale_linetype_manual(name = "WQG T-NO2-", values = c(1, 1),  
                        guide = guide_legend(override.aes = list(color = "red"))) +
  theme_bw() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
...
noplot <- ggplot(site_no, aes(x = DateTime, y = Value, color = EMS_ID, shape=CENSOR)) +
  geom_point(size=0.75) + 
  geom_hline(aes(yintercept = 10,linetype = "WQO Acute"), color = "blue") +
  geom_hline(aes(yintercept = 3,linetype = "WQG Chronic AL"), color = "red") +
  scale_linetype_manual(name = "Benchmark", values = c(2, 2),  
                        guide = guide_legend(override.aes = list(color = c("red", "blue")))) +
  theme_classic() +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
...
ntuplot <- ggplot(site_ntu, aes(x = DateTime, y = Value)) +
  ...
  theme_bw() +
  xlab("Date") +
  ylab("Turbidity (NTU)") + coord_cartesian(ylim=c(0,30)) +
  theme(legend.title = element_text(size = 6), legend.text = element_text(size = 6)) +
  theme(legend.key.size = unit(0.2, "cm")) + theme(legend.key = element_blank()) +
  theme(strip.text = element_text(face="bold", size=4, margin = margin(.2, 0, .2, 0, "mm"))) +
  theme(text=element_text(size=8)) +
...
(ntu_WQO<-turbidity2_WQO(plotdata, "E206635", 5, 10, 50))

#write csv of turbidity threshold, data shows clear flows for threshold is 10 mg/L 
write.csv(tubidity_WQO,'C:/R Projects/Similkameen-WQOs/data/report/CC_Plots/tables/CC_turbidity.csv', row.names = FALSE)
...
ntuplot2 <- ggplot(ntu_WQO, aes(x = DateTime, y = Value, col = Variable)) +
  ...
  labs(col = "E206635", shape="<MDL")
plot(ntuplot2)
ggsave(filename = "Turbidity_WQO E206635.png", plot = ntuplot2, h=4, w=6, units="in", dpi=300)
...
NH4_CC <- filter(NH4WQGs, EMS_ID == "E206635" | EMS_ID == "E249949" |
                     EMS_ID == "E249950" | EMS_ID ==  "E250424" | EMS_ID == "E206824" |
                     EMS_ID == "E206636" | EMS_ID == "E206637")


#plot data in specific order
NH4_CC$EMS_ID <- factor(NH4_CC$EMS_ID, 
                        levels=c( "E206635", "E249949", "E249950", "E250424", 
                                  "E206824", "E206636", "E206637"))


NH4plot2 <- ggplot(NH4_CC, aes(x = DateTime, y = Value, color = Variable, shape = CENSOR)) +
  geom_point(size=0.75) + 
  theme_bw() +
  xlab("Date") + 
  ylab("Dissolved Ammonia (mg/L)") + 
